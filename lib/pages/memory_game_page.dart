...
class MemoryGamePage extends StatefulWidget {
  ...
  const MemoryGamePage({super.key, required this.onExit});
  @override
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text('$_matchedPairs / $_totalPairs pairs found',
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: card.isMatched
              ? [
                  BoxShadow(
                      color: _cardColors[colorIdx].withOpacity(0.4),
                      blurRadius: 8)
                ]
              : null,
        ),
